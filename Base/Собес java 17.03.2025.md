...
Проектирование микросервисов для информирование клиентов, сложная задачка тем, что достаточно большая нагрузка и приходилось думать о оптимизации процессов 

Сложные задачки, это связанные с проектирование микросервисной архитектуры, которая удовлетворяла бизнес функциям и техническим аспектам 
